    ...
    return(
        <SafeAreaView style={styles.container}>
            ...
            <View style={styles.categoryList}>
                ...
                <TouchableOpacity style={styles.categoryItem} onPress={() => router.push( "categoryAdd" )}>
                    <View style={[styles.colorBox, { backgroundColor: "#D9D9D9", justifyContent: 'center', alignItems: 'center' }]}>
